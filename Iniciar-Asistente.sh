...
echo ""
echo "========================================="
echo -e "\e[36m       GENERADOR DE APUNTES\e[0m"
echo -e "\e[36m    mejoratudocencia.es\e[0m"
echo "========================================="
echo ""
...
if [ -f "$PROMPT_PATH" ]; then
    ...
    initial_prompt="Hola! Soy el asistente de generacion de apuntes educativos de mejoratudocencia.es. Por favor, ayudame a generar apuntes educativos profesionales."
fi
