...
Write-Host "       GENERADOR DE APUNTES" -ForegroundColor Cyan
Write-Host "    mejoratudocencia.es" -ForegroundColor Cyan
Write-Host "=========================================" -ForegroundColor Cyan
Write-Host ""
...
if (Test-Path $promptPath) {
    ...
    $initialPrompt = "Hola! Soy el asistente de generacion de apuntes educativos de mejoratudocencia.es. Por favor, ayudame a generar apuntes educativos profesionales."
}
...
if ($tool -eq "opencode") {
    ...
    Write-Host "✅ El prompt ya esta escrito. Presiona ENTER para enviarlo a la IA." -ForegroundColor Green
    Write-Host "💡 Luego podras seguir respondiendo a sus preguntas." -ForegroundColor Green
    Write-Host ""
