...
window.sectionsContent['errores-comunes'] = {
  ...
  content: `
    <h2>5. Errores comunes en Química y cómo evitarlos</h2>

    <p>Conocer los errores más frecuentes en Química te ayudará a <strong>no cometerlos</strong> el día del examen. Revisa esta lista cuidadosamente.</p>
    ...
    <h3>5.6. Errores de forma en Química</h3>
    ...
    <div class="callout callout-info my-6">
        ...
        <ul class="space-y-2">
            <li><input type="checkbox" class="mr-2"> ¿Todas las ecuaciones químicas están ajustadas?</li>
